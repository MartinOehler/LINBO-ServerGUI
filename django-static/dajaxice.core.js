...
var Dajaxice = {
    ...
    displayeditor: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.displayeditor', 'POST', callback_function, argv, custom_settings);
    },

    displayclienteditor: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.displayclienteditor', 'POST', callback_function, argv, custom_settings);
    },


    partitionSelectionChanged: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.partitionSelectionChanged', 'POST', callback_function, argv, custom_settings);
    },

    save_partitionselection: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.save_partitionselection', 'POST', callback_function, argv, custom_settings);
    },

    remove_partitionselection: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.remove_partitionselection', 'POST', callback_function, argv, custom_settings);
    },

    remove_partition: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.remove_partition', 'POST', callback_function, argv, custom_settings);
    },


    vmSelectionChanged: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.vmSelectionChanged', 'POST', callback_function, argv, custom_settings);
    },

    save_vm: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.save_vm', 'POST', callback_function, argv, custom_settings);
    },

    remove_vm: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.remove_vm', 'POST', callback_function, argv, custom_settings);
    },


    osSelectionChanged: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.osSelectionChanged', 'POST', callback_function, argv, custom_settings);
    },

    save_os: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.save_os', 'POST', callback_function, argv, custom_settings);
    },

    remove_os: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.remove_os', 'POST', callback_function, argv, custom_settings);
    },


    clientGroupSelectionChanged: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.clientGroupSelectionChanged', 'POST', callback_function, argv, custom_settings);
    },

    save_clientGroup: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.save_clientGroup', 'POST', callback_function, argv, custom_settings);
    },

    remove_clientGroup: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.remove_clientGroup', 'POST', callback_function, argv, custom_settings);
    },


    pxelinuxcfgSelectionChanged: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.pxelinuxcfgSelectionChanged', 'POST', callback_function, argv, custom_settings);
    },

    save_pxelinuxcfg: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.save_pxelinuxcfg', 'POST', callback_function, argv, custom_settings);
    },

    remove_pxelinuxcfg: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.remove_pxelinuxcfg', 'POST', callback_function, argv, custom_settings);
    },


    clientSelectionChanged: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.clientSelectionChanged', 'POST', callback_function, argv, custom_settings);
    },

    save_client: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.save_client', 'POST', callback_function, argv, custom_settings);
    },

    remove_client: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.remove_client', 'POST', callback_function, argv, custom_settings);
    },


    createClientFromTemplate: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.createClientFromTemplate', 'POST', callback_function, argv, custom_settings);
    },

    exportClientConfiguration: function(callback_function, argv, custom_settings){
	return Dajaxice.call('linboweb.linboserver.exportClientConfiguration', 'POST', callback_function, argv, custom_settings);
    },


    saveform: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.saveform', 'POST', callback_function, argv, custom_settings);
    },

    loadImageAdminDiv: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.loadImageAdminDiv', 'POST', callback_function, argv, custom_settings);
    },
    
    moveFileIncomingToCache: function(callback_function, argv, custom_settings){
        return Dajaxice.call('linboweb.linboserver.moveFileIncomingToCache', 'POST', callback_function, argv, custom_settings);
    }
